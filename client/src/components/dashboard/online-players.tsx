    ...
    <>
      <div className='game-mode-card multiplayer-card p-5 mb-6'>
        ...
        {onlinePlayers.length === 0 ? (
          <div className='bg-[#292929] p-5 rounded-lg text-center'>
          ...
          <div className='space-y-3'>
            {onlinePlayers.map((player) => (
              ...
              >
                ...
                <button
                  className='bg-[#292929] border border-[#90FE95] hover:bg-[#353B35] text-white px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:hover:scale-100'
      ...
      <div className='text-center'>
        ...
        <button onClick={onPlaySolo} className='search-players-button'>
          Play Solo Instead
        </button>
      </div>
    </>
