  ...
  return (
    <div className='min-h-screen bg-[#1C1C1E] text-white p-4'>
      ...
      <div className='space-y-4'>
        <button
          className='w-full py-6 text-2xl font-bold transition-transform hover:scale-105'
          style={{
            borderRadius: '10px',
      ...
      <div className='mt-12 mb-10'>
        <button
          className='w-full py-4 rounded-xl text-[#FFF] font-normal transition-all duration-300 hover:scale-105 active:scale-95 active:translate-y-1 active:shadow-none focus:outline-none focus:ring-2 focus:ring-[#3AFFE1] focus:ring-opacity-50'
          style={{
            borderRadius: '8px',
